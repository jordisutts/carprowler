...
from carprowler.views import hello_world, root_page, random_number
...
urlpatterns = [
    ...
    # 3 Reference the root of the cars app
    url(r'^cars/', include('cars.urls')),
    url(r'^signup/', include('signup.urls')),
]

# 3 Test that the cars URL works by running the server
# python3 manage.py runserver
# Go to localhost:8000/cars/
